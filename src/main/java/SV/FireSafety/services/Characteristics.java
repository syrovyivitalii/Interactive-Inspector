...
public class Characteristics {
    ...
    private String characteristicSolidHighlyFlammableSubstancesRooms(){
        //Категорія В
        text = "Тверді важкогорючі речовини, пожежна навантага на окремих ділянках площею не менше 10м² кожна перевищує 180 МДж/м² \n";
        //Категорія Д
        text += "Тверді важкогорючі речовини, пожежна навантага на окремих ділянках площею не менше 10м² кожна не перевищує 180 МДж/м²";
        return text;
    }
    ...
    private String characteristicHighlyFlammableLiquidRooms(){
        //Категорія В
        text = "Важкогорючі рідини, які здатні вибухати і/або горіти під час взаємодії з іншими речовинами з розрахунковим надлишковим тиском вибуху у приміщенні менше/дорівнює 5кПа \n";
        //Категорія Д
        text += "Важкогорючі рідини, в недостатній кількості для утворення вибухонебезпечної пароповітряної суміші з подальшим горінням \n";
        return text;
    }
    ...
    private String characteristicNonCombustibleSubstancesRooms(){
        //Категорія Г
        text = "Негорючі речовини у гарячому, розпеченому і/або розплавленому стані, процес яких супроводжується з виділенням променистого тепла, утворенням іскор і/або полум'я \n";
        //Категорія Д
        text += "Негорючі речовини в холодному стані";
        return text;
    }
